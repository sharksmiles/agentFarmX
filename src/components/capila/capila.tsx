...
const Capila: FC = () => {
    ...
    return (
        <>
            {capilaStats?.owned && !show && (
                <div
                    className="absolute left-[16px] bottom-[100px] z-[10] cursor-pointer animate-slideInFromBottomLeft"
                    onClick={() => {
                        setShow(true)
                    }}
                >
                    ...
                    <div className="flex justify-center items-center p-[16px] w-full flex-col">
                        ...
                        >
                            <div className="pt-2 w-full text-center">
                                <span className=" font-semibold">{t("Your")} Artela Capila</span>
                            </div>
                            ...
                            <div
                                className="flex gap-6 overflow-auto pb-6 z-[100] hide-scrollbar relative"
                                ref={containerRef}
                                onScroll={handleScroll}
                            >
                                {capilaStats?.token_list.map((token, index) => {
                                    return (
                                        <div
                                            key={token.token_id}
                            ...
                            <div className="py-2 w-full flex justify-center items-center z-0">
                                <button
