...
export default function AgentsPage() {
    ...
    return (
        <div className="w-full min-h-screen bg-[#1A1F25] text-white pb-28">
            {/* Header */}
                ...
                {agents.map(agent => {
                    ...
                    return (
                        <Link href={`/agents/${agent.id}`} key={agent.id}>
                            <div className="bg-[#252A31] rounded-2xl p-4 border border-[#353B45] hover:border-[#5964F5] transition-colors cursor-pointer">
                                {/* Top row */}
